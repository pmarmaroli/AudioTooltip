...
1. Hover over an audio file in Windows Explorer
2. Press Alt+A
...
The application supports transcription of audio files of any length using continuous recognition:

- Processes audio in segments
- Maintains context between segments
- Combines results into a complete transcript
...
If you encounter any issues or have questions, please contact support at [pmarmaroli@microsoft.com] or visit our GitHub repository at [https://github.com/pmarmaroli/AudioTooltip](https://github.com/pmarmaroli/AudioTooltip).
